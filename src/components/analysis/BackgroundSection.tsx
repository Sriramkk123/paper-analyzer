...
const BackgroundSection = ({ backgroundRelatedWork }: BackgroundSectionProps) => (
  <section>
    <div className="flex justify-between items-center mb-4">
      <h3 className="text-xl font-serif font-semibold text-navy">Background & Related Work</h3>
    ...
    >
      <ul className="space-y-2">
        {backgroundRelatedWork.map((item, idx) => (
          <motion.li
            key={idx}
