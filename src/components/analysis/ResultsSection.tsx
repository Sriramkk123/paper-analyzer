...
const ResultsSection = ({ metrics, comparison, achievements }: ResultsSectionProps) => {
  return (
    <section>
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-serif font-semibold text-navy">Results and Findings</h3>
      ...
      <div className="space-y-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {metrics.map((metric, index) => (
              <motion.div 
                ...
                className="bg-blue-50 p-3 rounded-md flex items-center"
              >
                ...
                <span className="text-navy">{metric}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <h4 className="font-medium text-navy mb-3 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mr-2 text-teal">
